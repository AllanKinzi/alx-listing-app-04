    ...
    <div className="p-2 w-full max-w-sm mx-auto">
      ...
      <div className="flex gap-1 mb-2 flex-wrap">
        {property.tags?.map((tag) => (
          <div key={tag} className="text-xs rounded-full flex items-center justify-center">
      ...
      <div className="flex flex-col">
        <div className="flex justify-between items-center">
          ...
          <div className="flex gap-1 items-center shrink-0">
            <Image alt="Star" width={20} height={20} src="/assets/icons/Star.svg" />
      ...
      <div className="flex justify-between items-center gap-2">
        <div className="flex items-center gap-1 lg:gap-2 border rounded-full px-2 lg:px-4 py-1">
          ...
          <div className="flex items-center gap-1">
            <Image src="/assets/icons/bathtub.svg" alt="bathtub" width={16} height={16} />
